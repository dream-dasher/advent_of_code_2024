//! CLI interface to run Parts 1 & 2 of Day05 of Advent of Code 2024.

use std::path::PathBuf;

use clap::{Parser, Subcommand, ValueEnum};
use day05::{CUSTOM_INPUT, EXAMPLE_INPUT, FINAL_INPUT, Result,
            active_global_default_tracing_subscriber, process_part1, process_part2};
use tracing::{self as tea, Level, instrument};

/// Choose to run Part 1 or 2 of Day05 of Advent of Code 2024.
#[derive(Parser, Debug)]
#[command(
        version,
        about,
